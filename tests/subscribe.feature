...
Given GET request to the hub is prepared with all required information
...
GGiven GET request to the hub is prepared with all required information
When GET request is sent to the hub and the connection hangs
